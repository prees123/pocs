...
class SubHomePage extends React.Component {
  render () {
    const {classes} = this.props
    let productImageLink
    let productImage
    if (this.props.categoryName === 'Pricing' || this.props.topLevelCategoryName === 'Pricing') {
      productImageLink = constants.productImageLinks.pricing
    } else {
      productImageLink = constants.productImageLinks.promotions
    }
    productImage = <img className={classes.ivyPromo} alt="Product" src={productImageLink} />
...
export default withStyles(styles)(connect(mapStateToProps)(SubHomePage))
